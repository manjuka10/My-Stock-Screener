...
# Base date = 28-Jul
#
# If the exact date was a holiday/weekend,
# use the latest available trading day on or before
...
def calculate_stock(
    ...
    # 1 DAY RETURN
    #
    # Previous trading day's close -> live price
    # ========================================================
    ...
    ema_data.loc[live_timestamp] = current_price
