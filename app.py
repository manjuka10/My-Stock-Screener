...
#
# 28-Aug -> 28-Jul
# If 28-Jul is holiday, use previous available trading day.
# ============================================================
...
def calculate_stock(
    ...
    #
    # Used for returns and EMA.
    # Today's incomplete daily candle is not used here.
    # --------------------------------------------------------
    ...
    #
    # Therefore today's actual traded High/Low is included.
    #
